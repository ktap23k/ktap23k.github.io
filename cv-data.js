  ...
  langs: {
    en: {
      ...
      projects: [
        {
          name: 'Anyjob',
          period: 'Large-scale product',
          company: 'Recruitment platform',
          description:
            'Built hiring-platform services across authentication, candidate flows, and operational integrations using FastAPI, Authentik, Nuxt, PostgreSQL, Kubernetes, Lambda, and Flutter.',
    ...
    vi: {
      ...
      projects: [
        {
          name: 'Anyjob',
          period: 'Sản phẩm quy mô lớn',
          company: 'Nền tảng tuyển dụng',
          description:
